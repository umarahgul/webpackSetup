...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _curd_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./curd.js */ \"./src/curd.js\");\n/* harmony import */ var _status_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./status.js */ \"./src/status.js\");\n\n\n\n\ndocument.addEventListener('DOMContentLoaded', _curd_js__WEBPACK_IMPORTED_MODULE_1__.populateList);\ndocument.addEventListener('DOMContentLoaded', () => {\n  const storedTodoList = (0,_curd_js__WEBPACK_IMPORTED_MODULE_1__.retrieveTodoListFromLocalStorage)();\n  _curd_js__WEBPACK_IMPORTED_MODULE_1__.todoList.push(...storedTodoList);\n\n  (0,_curd_js__WEBPACK_IMPORTED_MODULE_1__.curdFunctionality)();\n});\n\n(0,_status_js__WEBPACK_IMPORTED_MODULE_2__.updateStatus)(_curd_js__WEBPACK_IMPORTED_MODULE_1__.todoList, _curd_js__WEBPACK_IMPORTED_MODULE_1__.saveTodoListToLocalStorage);\ndocument.addEventListener('DOMContentLoaded', () => {\n  // Retrieve data and populate the todoList array\n  const storedTodoList = (0,_curd_js__WEBPACK_IMPORTED_MODULE_1__.retrieveTodoListFromLocalStorage)();\n  _curd_js__WEBPACK_IMPORTED_MODULE_1__.todoList.push(...storedTodoList);\n  \n  \n// alert('length' + todoList.length);\n\n  // alert(\"hellllo id \" + `chk${x}`  );\n  (0,_status_js__WEBPACK_IMPORTED_MODULE_2__.updateStatus)(checkbox, _curd_js__WEBPACK_IMPORTED_MODULE_1__.todoList, _curd_js__WEBPACK_IMPORTED_MODULE_1__.saveTodoListToLocalStorage);\n\n});\n\nconst clearButton = document.getElementById('clearAll');\n(0,_status_js__WEBPACK_IMPORTED_MODULE_2__.addClearButtonEventListener)(clearButton, _curd_js__WEBPACK_IMPORTED_MODULE_1__.todoList, _curd_js__WEBPACK_IMPORTED_MODULE_1__.saveTodoListToLocalStorage, _curd_js__WEBPACK_IMPORTED_MODULE_1__.populateList);\n\n// Add event listener to each checkbox for status updates\n\n\n//# sourceURL=webpack://webpacksetup/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addClearButtonEventListener: () => (/* binding */ addClearButtonEventListener),\n/* harmony export */   updateStatus: () => (/* binding */ updateStatus)\n/* harmony export */ });\n\n\n\nconst updateStatus = (checkbox, todoList, saveTodoListToLocalStorage) => {\n\n\n   alert(\"hello\" + checkboxIndex);\n  checkbox.addEventListener('change', () => {\n    alert(\"change worked\");\n    const storedTodoList = localStorage.getItem('todoList');\n    JSON.parse(storedTodoList);\n  todoList.push(...storedTodoList);\n  populateList();\n  \n    todoList[checkboxIndex].completed = checkbox.checked;\n   \n    saveTodoListToLocalStorage();\n  });\n};\n\n\n\n\nconst addClearButtonEventListener = (clearButton, todoList,\n  saveTodoListToLocalStorage, populateList) => {\n  clearButton.addEventListener('click', () => {\n    \n    for(let x=0; x<todoList.length; x += 1){\n    if(todoList[x].completed === true){\n    const chkbx = document.getElementById(`id${x}`)\n    chkbx.remove();\n    chkbx.style.display = 'none';\n    todoList.splice(x, 1);\n        }\n    }\n    const updatedTodoList = todoList.filter((task) => !task.completed);\n    todoList.length = 0;\n    Array.prototype.push.apply(todoList, updatedTodoList);\n\n    saveTodoListToLocalStorage();\n    populateList();\n  });\n};\n\n//# sourceURL=webpack://webpacksetup/./src/status.js?");
