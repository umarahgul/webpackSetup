...
<ul>
<li> User is able to add a list item for todo list.</li>
<li> User is able to 'check' in checkbox for completed list items .</li>
<li> The webapp enables user to see all the to do items to be done.</li>
...
```sh
  cd my-folder
  git clone git@github.com:umarahgul/webpackSetup.git
```
...
If you wish to contribute to the 'to do List' project, you can follow these steps:
